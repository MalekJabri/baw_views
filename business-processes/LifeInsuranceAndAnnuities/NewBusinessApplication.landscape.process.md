# New Business Application Process (Landscape View)
...
## Process Diagram (Landscape - Left to Right)

```mermaid
flowchart LR
    Start([Start:<br/>Application<br/>Received])
    
    subgraph Agent[Insurance Agent]
        direction TB
        A1[Collect<br/>Application<br/>Data]
        A2[Submit<br/>Application]
        A3[Provide<br/>Additional<br/>Info]
    end
    
    subgraph System[Automated System]
        direction TB
        S1[Validate<br/>Application]
        S2{Application<br/>Complete?}
        S3[Route to<br/>Underwriter]
        S4[Generate<br/>Policy<br/>Document]
        S5[Send<br/>Decline<br/>Letter]
    end
    
    subgraph Underwriter[Underwriter]
        direction TB
        U1[Review<br/>Application]
        U2[Order<br/>Requirements]
        U3[Assess<br/>Risk]
    ...
    subgraph Medical[Medical Services]
        direction TB
        M1[Schedule<br/>Medical<br/>Exam]
        M2[Conduct<br/>Exam]
        M3[Submit<br/>Results]
    end
    
    Issue[Issue<br/>Policy]
    End([End:<br/>Process<br/>Complete])
...
```json
{
  ...
  "generatedDate": "2026-05-06T10:40:00Z",
  "bpmnPreparation": {
    "readyForBPMN": true,
...
**Last Updated:** 2026-05-06T10:40:00Z  
**Version:** 1.0.0  
**Diagram Orientation:** Landscape (Left to Right)