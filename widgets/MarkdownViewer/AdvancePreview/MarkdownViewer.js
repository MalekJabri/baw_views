...
var mixObject = {
	createPreview: function(containingDiv, labelText, callback){
		...
		require([ "dojo/dom-construct", "dojo/dom-class", "dojo/dom-attr", bpmextUri], this.lang.hitch(this, function(domConstruct, domClass, domAttr, bpmext) {
			...
			this.context.coachViewData.label = this.context.coachViewData.containingDiv.querySelector("div[data-temp-id='" + tempID + "']  .markdown-title");
	...
	propertyChanged: function(propertyName, propertyValue){
		...
		require(["dojo/dom-style", "dojo/dom-class",  "dojo/dom-construct", configHelperUri], this.lang.hitch(this, function(domStyle, domClass, domConstruct, configHelper){
			...
			if (propertyName == "@style") {
			...
			} else if (propertyName == "markdownCustomTitle") {
				console.log("MarkdownViewer-Preview:propertyChanged() : Property Name: " + propertyName + ", value: " + propertyValue);
				if (propertyValue === null || propertyValue === undefined || propertyValue == "") {
					this.context.coachViewData.label.innerHTML = "Markdown Viewer";
				} else {
					this.context.coachViewData.label.innerHTML = propertyValue;
				}
			} else if (propertyName == "markdownHideTitle") {
				console.log("MarkdownViewer-Preview:propertyChanged() : Property Name: " + propertyName + ", value: " + propertyValue);
				...
				console.log("MarkdownViewer-Preview:propertyChanged() : Property Name: " + propertyName + ", value: " + propertyValue);
				var container = this.context.coachViewData.containingDiv.querySelector(".markdown-viewer-container");
				if (container) {
